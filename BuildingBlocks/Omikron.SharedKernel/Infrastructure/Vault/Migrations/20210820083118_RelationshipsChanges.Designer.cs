...
namespace Omikron.SharedKernel.Infrastructure.Vault.Migrations
{
    ...
    [Migration("20210820083118_RelationshipsChanges")]
    partial class RelationshipsChanges
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Omikron.VaultService.Domain.Models.Entities.VaultItemValue", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("VaultItemValue");
                });
            ...
            modelBuilder.Entity("Omikron.VaultService.Domain.Models.Entities.AccountValue", b =>
                {
                    b.HasBaseType("Omikron.VaultService.Domain.Models.Entities.VaultItemValue");
                    ...
                    b.HasDiscriminator().HasValue("AccountValue");
                });
            ...
            modelBuilder.Entity("Omikron.VaultService.Domain.Models.Entities.PropertyValue", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("PropertyValue");
                });
            ...
            modelBuilder.Entity("Omikron.VaultService.Domain.Models.Entities.VehicleValue", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("VehicleValue");
                });
