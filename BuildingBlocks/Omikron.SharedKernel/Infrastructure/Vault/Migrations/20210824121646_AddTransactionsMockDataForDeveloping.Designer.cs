...
namespace Omikron.SharedKernel.Infrastructure.Vault.Migrations
{
    ...
    [Migration("20210824121646_AddTransactionsMockDataForDeveloping")]
    partial class AddTransactionsMockDataForDeveloping
    {
            ...
            modelBuilder.Entity("Omikron.VaultService.Domain.Models.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2021, 8, 24, 12, 16, 46, 267, DateTimeKind.Utc).AddTicks(5370),
                            Currency = "GBP",
                            ExpiryDate = new DateTime(2021, 8, 24, 12, 17, 16, 270, DateTimeKind.Utc).AddTicks(2641),
                            ExternalId = new Guid("48ab7b04-218d-4205-a177-437db3d0a552"),
                            IdentificationNumber = "111111•11111111",
                            ImageUrl = "",
                            ModifiedAt = new DateTime(2021, 8, 24, 12, 16, 46, 267, DateTimeKind.Utc).AddTicks(5383),
                            Name = "Test",
            ...
            modelBuilder.Entity("Omikron.VaultService.Domain.Models.Entities.Transaction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2021, 8, 24, 12, 16, 46, 273, DateTimeKind.Utc).AddTicks(8156),
                            Currency = "GBP",
                            Date = new DateTime(2021, 8, 22, 12, 16, 46, 273, DateTimeKind.Utc).AddTicks(7766),
                            MerchantName = "Amazon",
                            ModifiedAt = new DateTime(2021, 8, 24, 12, 16, 46, 273, DateTimeKind.Utc).AddTicks(8159)
                        },
                        new
                        {
                            ...
                            Amount = 16.42m,
                            Category = "Gaming",
                            CreatedAt = new DateTime(2021, 8, 24, 12, 16, 46, 274, DateTimeKind.Utc).AddTicks(75),
                            Currency = "GBP",
                            Date = new DateTime(2021, 8, 22, 12, 16, 46, 273, DateTimeKind.Utc).AddTicks(7766),
                            MerchantName = "Steam",
                            ModifiedAt = new DateTime(2021, 8, 24, 12, 16, 46, 274, DateTimeKind.Utc).AddTicks(78)
                        },
                        new
                        {
                            ...
                            Amount = 76.32m,
                            Category = "Groceries",
                            CreatedAt = new DateTime(2021, 8, 24, 12, 16, 46, 274, DateTimeKind.Utc).AddTicks(93),
                            Currency = "GBP",
                            Date = new DateTime(2021, 8, 24, 12, 16, 46, 273, DateTimeKind.Utc).AddTicks(7766),
                            MerchantName = "Target",
                            ModifiedAt = new DateTime(2021, 8, 24, 12, 16, 46, 274, DateTimeKind.Utc).AddTicks(94)
                        },
                        new
                        {
                            ...
                            Amount = 123.23m,
                            Category = "Groceries",
                            CreatedAt = new DateTime(2021, 8, 24, 12, 16, 46, 274, DateTimeKind.Utc).AddTicks(99),
                            Currency = "GBP",
                            Date = new DateTime(2021, 8, 24, 12, 16, 46, 273, DateTimeKind.Utc).AddTicks(7766),
                            MerchantName = "Lidl",
                            ModifiedAt = new DateTime(2021, 8, 24, 12, 16, 46, 274, DateTimeKind.Utc).AddTicks(100)
                        });
                });
