...
namespace Omikron.SharedKernel.Infrastructure.Vault.Migrations
{
    ...
    [Migration("20210912205912_PersonalItemModification")]
    partial class PersonalItemModification
    {
            ...
            modelBuilder.Entity("Omikron.VaultService.Domain.Models.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2021, 9, 12, 20, 59, 11, 601, DateTimeKind.Utc).AddTicks(4764),
                            Currency = "GBP",
                            ExpiryDate = new DateTime(2021, 9, 12, 20, 59, 41, 603, DateTimeKind.Utc).AddTicks(3597),
                            ExternalId = new Guid("48ab7b04-218d-4205-a177-437db3d0a552"),
                            IdentificationNumber = "111111•11111111",
                            ImageUrl = "",
                            ModifiedAt = new DateTime(2021, 9, 12, 20, 59, 11, 601, DateTimeKind.Utc).AddTicks(4777),
                            Name = "Test",
            ...
            modelBuilder.Entity("Omikron.VaultService.Domain.Models.Entities.Transaction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2021, 9, 12, 20, 59, 11, 606, DateTimeKind.Utc).AddTicks(3664),
                            Currency = "GBP",
                            Date = new DateTime(2021, 9, 10, 20, 59, 11, 606, DateTimeKind.Utc).AddTicks(3356),
                            MerchantName = "Amazon",
                            ModifiedAt = new DateTime(2021, 9, 12, 20, 59, 11, 606, DateTimeKind.Utc).AddTicks(3665)
                        },
                        new
                        {
                            ...
                            Amount = 16.42m,
                            Category = "Gaming",
                            CreatedAt = new DateTime(2021, 9, 12, 20, 59, 11, 606, DateTimeKind.Utc).AddTicks(4812),
                            Currency = "GBP",
                            Date = new DateTime(2021, 9, 10, 20, 59, 11, 606, DateTimeKind.Utc).AddTicks(3356),
                            MerchantName = "Steam",
                            ModifiedAt = new DateTime(2021, 9, 12, 20, 59, 11, 606, DateTimeKind.Utc).AddTicks(4813)
                        },
                        new
                        {
                            ...
                            Amount = 76.32m,
                            Category = "Groceries",
                            CreatedAt = new DateTime(2021, 9, 12, 20, 59, 11, 606, DateTimeKind.Utc).AddTicks(4822),
                            Currency = "GBP",
                            Date = new DateTime(2021, 9, 12, 20, 59, 11, 606, DateTimeKind.Utc).AddTicks(3356),
                            MerchantName = "Target",
                            ModifiedAt = new DateTime(2021, 9, 12, 20, 59, 11, 606, DateTimeKind.Utc).AddTicks(4823)
                        },
                        new
                        {
                            ...
                            Amount = 123.23m,
                            Category = "Groceries",
                            CreatedAt = new DateTime(2021, 9, 12, 20, 59, 11, 606, DateTimeKind.Utc).AddTicks(4826),
                            Currency = "GBP",
                            Date = new DateTime(2021, 9, 12, 20, 59, 11, 606, DateTimeKind.Utc).AddTicks(3356),
                            MerchantName = "Lidl",
                            ModifiedAt = new DateTime(2021, 9, 12, 20, 59, 11, 606, DateTimeKind.Utc).AddTicks(4827)
                        });
                });
