...
namespace Omikron.SharedKernel.Infrastructure.Vault.Migrations
{
    ...
    [Migration("20210912210113_AccountModification")]
            ...
            modelBuilder.Entity("Omikron.VaultService.Domain.Models.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2021, 9, 12, 21, 1, 12, 836, DateTimeKind.Utc).AddTicks(7110),
                            Currency = "GBP",
                            ExpiryDate = new DateTime(2021, 9, 12, 21, 1, 42, 838, DateTimeKind.Utc).AddTicks(6447),
                            ExternalId = new Guid("48ab7b04-218d-4205-a177-437db3d0a552"),
                            IdentificationNumber = "111111•11111111",
                            ImageUrl = "",
                            ModifiedAt = new DateTime(2021, 9, 12, 21, 1, 12, 836, DateTimeKind.Utc).AddTicks(7121),
                            Name = "Test",
            ...
            modelBuilder.Entity("Omikron.VaultService.Domain.Models.Entities.Transaction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2021, 9, 12, 21, 1, 12, 841, DateTimeKind.Utc).AddTicks(4317),
                            Currency = "GBP",
                            Date = new DateTime(2021, 9, 10, 21, 1, 12, 841, DateTimeKind.Utc).AddTicks(4065),
                            MerchantName = "Amazon",
                            ModifiedAt = new DateTime(2021, 9, 12, 21, 1, 12, 841, DateTimeKind.Utc).AddTicks(4318)
                        },
                        new
                        {
                            ...
                            Amount = 16.42m,
                            Category = "Gaming",
                            CreatedAt = new DateTime(2021, 9, 12, 21, 1, 12, 841, DateTimeKind.Utc).AddTicks(5439),
                            Currency = "GBP",
                            Date = new DateTime(2021, 9, 10, 21, 1, 12, 841, DateTimeKind.Utc).AddTicks(4065),
                            MerchantName = "Steam",
                            ModifiedAt = new DateTime(2021, 9, 12, 21, 1, 12, 841, DateTimeKind.Utc).AddTicks(5441)
                        },
                        new
                        {
                            ...
                            Amount = 76.32m,
                            Category = "Groceries",
                            CreatedAt = new DateTime(2021, 9, 12, 21, 1, 12, 841, DateTimeKind.Utc).AddTicks(5450),
                            Currency = "GBP",
                            Date = new DateTime(2021, 9, 12, 21, 1, 12, 841, DateTimeKind.Utc).AddTicks(4065),
                            MerchantName = "Target",
                            ModifiedAt = new DateTime(2021, 9, 12, 21, 1, 12, 841, DateTimeKind.Utc).AddTicks(5450)
                        },
                        new
                        {
                            ...
                            Amount = 123.23m,
                            Category = "Groceries",
                            CreatedAt = new DateTime(2021, 9, 12, 21, 1, 12, 841, DateTimeKind.Utc).AddTicks(5454),
                            Currency = "GBP",
                            Date = new DateTime(2021, 9, 12, 21, 1, 12, 841, DateTimeKind.Utc).AddTicks(4065),
                            MerchantName = "Lidl",
                            ModifiedAt = new DateTime(2021, 9, 12, 21, 1, 12, 841, DateTimeKind.Utc).AddTicks(5454)
                        });
                });
