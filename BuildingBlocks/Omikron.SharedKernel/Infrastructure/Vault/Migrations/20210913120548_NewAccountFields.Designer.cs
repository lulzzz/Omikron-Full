...
namespace Omikron.SharedKernel.Infrastructure.Vault.Migrations
{
    ...
    [Migration("20210913120548_NewAccountFields")]
            ...
            modelBuilder.Entity("Omikron.VaultService.Domain.Models.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2021, 9, 13, 12, 5, 48, 485, DateTimeKind.Utc).AddTicks(1842),
                            Currency = "GBP",
                            ExpiryDate = new DateTime(2021, 9, 13, 12, 6, 18, 490, DateTimeKind.Utc).AddTicks(5877),
                            ExternalId = new Guid("48ab7b04-218d-4205-a177-437db3d0a552"),
                            IdentificationNumber = "111111•11111111",
                            ImageUrl = "",
                            ModifiedAt = new DateTime(2021, 9, 13, 12, 5, 48, 485, DateTimeKind.Utc).AddTicks(1850),
                            Name = "Test",
            ...
            modelBuilder.Entity("Omikron.VaultService.Domain.Models.Entities.Transaction", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2021, 9, 13, 12, 5, 48, 493, DateTimeKind.Utc).AddTicks(8582),
                            Currency = "GBP",
                            Date = new DateTime(2021, 9, 11, 12, 5, 48, 493, DateTimeKind.Utc).AddTicks(7866),
                            MerchantName = "Amazon",
                            ModifiedAt = new DateTime(2021, 9, 13, 12, 5, 48, 493, DateTimeKind.Utc).AddTicks(8584)
                        },
                        new
                        {
                            ...
                            Amount = 16.42m,
                            Category = "Gaming",
                            CreatedAt = new DateTime(2021, 9, 13, 12, 5, 48, 494, DateTimeKind.Utc).AddTicks(850),
                            Currency = "GBP",
                            Date = new DateTime(2021, 9, 11, 12, 5, 48, 493, DateTimeKind.Utc).AddTicks(7866),
                            MerchantName = "Steam",
                            ModifiedAt = new DateTime(2021, 9, 13, 12, 5, 48, 494, DateTimeKind.Utc).AddTicks(851)
                        },
                        new
                        {
                            ...
                            Amount = 76.32m,
                            Category = "Groceries",
                            CreatedAt = new DateTime(2021, 9, 13, 12, 5, 48, 494, DateTimeKind.Utc).AddTicks(864),
                            Currency = "GBP",
                            Date = new DateTime(2021, 9, 13, 12, 5, 48, 493, DateTimeKind.Utc).AddTicks(7866),
                            MerchantName = "Target",
                            ModifiedAt = new DateTime(2021, 9, 13, 12, 5, 48, 494, DateTimeKind.Utc).AddTicks(865)
                        },
                        new
                        {
                            ...
                            Amount = 123.23m,
                            Category = "Groceries",
                            CreatedAt = new DateTime(2021, 9, 13, 12, 5, 48, 494, DateTimeKind.Utc).AddTicks(868),
                            Currency = "GBP",
                            Date = new DateTime(2021, 9, 13, 12, 5, 48, 493, DateTimeKind.Utc).AddTicks(7866),
                            MerchantName = "Lidl",
                            ModifiedAt = new DateTime(2021, 9, 13, 12, 5, 48, 494, DateTimeKind.Utc).AddTicks(869)
                        });
                });
