...
namespace Omikron.SharedKernel.Infrastructure.Vault.Migrations
{
    ...
    [Migration("20210927173319_AddMerchantLogoToTransactions")]
    partial class AddMerchantLogoToTransactions
    {
            ...
            modelBuilder.Entity("Omikron.SharedKernel.Infrastructure.Data.Model.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AzureAssetStatus = 4,
                            CreatedAt = new DateTime(2021, 9, 27, 17, 33, 18, 919, DateTimeKind.Utc).AddTicks(6254),
                            HostName = "Omikron",
                            Identifier = "Omikron",
                            Logo = "images/applicita-software-logo.png",
                            ModifiedAt = new DateTime(2021, 9, 27, 17, 33, 18, 919, DateTimeKind.Utc).AddTicks(6269),
