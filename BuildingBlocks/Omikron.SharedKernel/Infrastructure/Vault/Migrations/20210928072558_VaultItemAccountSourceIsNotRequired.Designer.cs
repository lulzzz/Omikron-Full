...
namespace Omikron.SharedKernel.Infrastructure.Vault.Migrations
{
    ...
    [Migration("20210928072558_VaultItemAccountSourceIsNotRequired")]
    partial class VaultItemAccountSourceIsNotRequired
    {
            ...
            modelBuilder.Entity("Omikron.SharedKernel.Infrastructure.Data.Model.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AzureAssetStatus = 4,
                            CreatedAt = new DateTime(2021, 9, 28, 7, 25, 57, 694, DateTimeKind.Utc).AddTicks(6531),
                            HostName = "Omikron",
                            Identifier = "Omikron",
                            Logo = "images/applicita-software-logo.png",
                            ModifiedAt = new DateTime(2021, 9, 28, 7, 25, 57, 694, DateTimeKind.Utc).AddTicks(6548),
