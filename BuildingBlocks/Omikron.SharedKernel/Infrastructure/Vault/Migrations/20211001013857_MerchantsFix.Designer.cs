...
namespace Omikron.SharedKernel.Infrastructure.Vault.Migrations
{
    ...
    [Migration("20211001013857_MerchantsFix")]
    partial class MerchantsFix
    {
            ...
            modelBuilder.Entity("Omikron.SharedKernel.Infrastructure.Data.Model.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AzureAssetStatus = 4,
                            CreatedAt = new DateTime(2021, 10, 1, 1, 38, 56, 921, DateTimeKind.Utc).AddTicks(1534),
                            HostName = "Omikron",
                            Identifier = "Omikron",
                            Logo = "images/applicita-software-logo.png",
                            ModifiedAt = new DateTime(2021, 10, 1, 1, 38, 56, 921, DateTimeKind.Utc).AddTicks(1544),
